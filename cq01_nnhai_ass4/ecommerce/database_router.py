class DatabaseRouter:
    ...
    def db_for_read(self, model, **hints):
        ...
        if app_label == 'guest_customer_service':
            ...
            return 'items'
        elif app_label in ['cart_service', 'order_service', 'paying_service', 'shipping_service', 'rating_service']:
            return 'transactions'
    ...
    def allow_relation(self, obj1, obj2, **hints):
        ...
        """
        transaction_apps = ['cart_service', 'order_service', 'paying_service', 'shipping_service', 'rating_service']
        ...
        # Allow relations involving auth models
    ...
    def allow_migrate(self, db, app_label, model_name=None, **hints):
        ...
        if db == 'guest_customers':
            ...
            return app_label in ['cart_service', 'order_service', 'paying_service', 'shipping_service', 'rating_service']
        elif db == 'default':
